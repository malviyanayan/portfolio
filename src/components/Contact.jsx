  ...
  return (
    <section
      ...
      className={`contact-section d-flex align-items-center justify-content-center ${
        theme ? "contact-light" : "contact-dark"
      }`}
    >
      <div className="container">
        ...
        <form
          ...
          className={`contact-form ${theme ? "contact-form-light" : "contact-form-dark"}`}
        >
          {/* Name */}
          <FadeInOnScroll>
          ...
          <FadeInOnScroll>
            <div className="form-submit">
              <button
                type="submit"
                className={`submit-btn ${theme ? "btn-light-mode" : "btn-dark-mode"}`}
